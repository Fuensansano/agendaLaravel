...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        <div class="container">
            <img src="/img/telefono.png" class="me-1" alt="logo">
    ...
    <main class="py-4">
        @if(session()->has('alert'))
            <div class="container">
                ...
                <div class="alert alert-{{ session()->get('alert')['type'] }} d-flex align-items-center mt-3" style="height: 60px" role="alert">
                    <svg class="bi flex-shrink-0 me-2" role="img" aria-label="Info:" style="height: 40px">
